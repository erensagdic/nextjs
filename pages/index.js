            ...
            <Layout>
                <div className="container">
                    <div className="col-12 mt-5 text-center">
                        <h2>Welcome to our Rick & Morty Wiki</h2>
                    </div>
                    <div className="row">
                        <div className="col-5 m-5 p-4 shadow-sm overflow-scroll" style={{height: '24rem'}}>
                        ...
                        <div className="col-5 m-5 p-4 shadow" style={{height: '24rem'}}>
                            <Slider {...settings}>
                                <div className="p-4 d-flex justify-content-center" style={sliderDiv}>
                                    <img src="https://images7.alphacoders.com/633/633262.png" alt=""
                                         style={sliderImage}/>
                                </div>
                                <div className="p-4 d-flex justify-content-center" style={sliderDiv}>
                                    <img src="https://www.cizgikafe.com/wp-content/uploads/2020/09/rick.jpg" alt=""
                                         style={sliderImage}/>
                                </div>
                                <div className="p-4 d-flex justify-content-center" style={sliderDiv}>
